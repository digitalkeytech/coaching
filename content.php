...
<article id="post-<?php the_ID(); ?>" <?php post_class( ); ?>>
	...
	<?php if ( has_post_thumbnail() ) { // if there is featured image for this post you may wrapper for it ?>
		...
		<?php if(comments_open( get_the_ID() )) { ?>
			<span class='post-comments'><span class="meta-icon icon">&#xf086;</span><?php comments_popup_link( smt_translate( 'noresponses' ), smt_translate( 'oneresponse' ), smt_translate( 'multiresponse' ) ); ?></span>
	...
	<?php if ( !is_single() ) : ?>
		...
		<div class="entry-summary">
			...
			<div class="entry-meta">
				<span class='post-date updated'><span class="meta-icon icon">&#xf073;</span><?php echo get_the_date('F d, Y'); ?></span>		
				<span class="post-author vcard"><span class="fn"><span class="meta-icon icon">&#xf007;</span><?php echo the_author_posts_link();?></span></span>
				<?php if( comments_open( get_the_ID() ) && !has_post_thumbnail() ) { ?>
					<span class='post-comments'><span class="meta-icon icon">&#xf086;</span><?php comments_popup_link( smt_translate( 'noresponses' ), smt_translate( 'oneresponse' ), smt_translate( 'multiresponse' ) ); ?></span>
				<?php } edit_post_link( smt_translate( 'edit' ), '     |     <span class="edit-link">', '</span>' ); ?>
			</div>
