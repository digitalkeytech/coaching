<?php
	...
	function smt_setup() {
		...
		set_post_thumbnail_size( 660, 280, true );
		add_image_size( 'smt_slide', 2000, 890, true );
		add_image_size( 'smt_showroom', 180, 180, true );
		add_image_size( 'smt_related', 272, 160, true );
		add_image_size( 'smt_sidebarposts', 272, 110, true );
